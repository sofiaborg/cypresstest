...
var _todoClass = require("./modules/todoClass");
let taskOne = new _todoClass.Todos("jump");
let taskTwo = new _todoClass.Todos("run");
let taskThree = new _todoClass.Todos("climb");
...
function btnClick(i) {
    ...
    if (listItem[i].status == true) this.checked = true;
    printTodos();
}
function remove(i) {
    listItem.splice(i, 1);
...
function handleNewTask() {
    ...
    if (input.value.trim() != "") {
        let newTask = new _todoClass.Todos(input.value);
...
},{"./modules/todoClass":"8dcS0"}],"8dcS0":[function(require,module,exports) {
...
},{}]},["e4k7L","7BLcd"], "7BLcd", "parcelRequire998b")
